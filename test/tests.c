...
START_TEST(Day21_P1)
{	
	int exampleResult = day21_p1("../src/Day21/day21.example");
	if(showResults){
		printf("Day21 Part1 Example: %d\n", exampleResult);
	
		int inputResult = day21_p1("../src/Day21/day21.input");
		printf("Day21 Part1 Input  : %d\n", inputResult);
	}
	ck_assert_int_eq(exampleResult , 739785);
}
END_TEST

START_TEST(Day21_P2)
{	
	long long int exampleResult = day21_p2("../src/Day21/day21.example");
	if(showResults){
		printf("Day21 Part2 Example: %lld\n", exampleResult);
	
		long long int inputResult = day21_p2("../src/Day21/day21.input");
		printf("Day21 Part2 Input  : %lld\n", inputResult);
		printf("\n");
	}
	ck_assert_int_eq(exampleResult , 444356092776315);
}
END_TEST

START_TEST(Day22_P1)
{	
	int exampleResult = day22_p1("../src/Day22/examples/day22.example");
	int exampleResult2 = day22_p1("../src/Day22/examples/day22.example2");
	if(showResults){
		printf("Day22 Part1 Example : %d\n", exampleResult);
		printf("Day22 Part1 Example2: %d\n", exampleResult2);
	
		int inputResult = day22_p1("../src/Day22/day22.input");
		printf("Day22 Part1 Input   : %d\n", inputResult);
	}
	ck_assert_int_eq(exampleResult , 39);
	ck_assert_int_eq(exampleResult2, 590784);
}
END_TEST

START_TEST(Day22_P2)
{	
	long long int exampleResult = day22_p2("../src/Day22/examples/day22.example");
	long long int exampleResult2 = day22_p2("../src/Day22/examples/day22.example3");
	if(showResults){
		printf("Day22 Part2 Example : %lld\n", exampleResult);
		printf("Day22 Part2 Example2: %lld\n", exampleResult2);
	
		long long int inputResult = day22_p2("../src/Day22/day22.input");
		printf("Day22 Part2 Input   : %lld\n", inputResult);
		printf("\n");
	}
	ck_assert_int_eq(exampleResult , 39);
	ck_assert_int_eq(exampleResult2, 2758514936282235);
}
END_TEST

START_TEST(Day23_P1)
{	
	int exampleResult = day23_p1("../src/Day23/day23.example");
	if(showResults){
		printf("Day23 Part1 Example: %d\n", exampleResult);
	
		//int inputResult = day23_p1("../src/Day23/day23.input");
		//printf("Day23 Part1 Input  : %d\n", inputResult);
		printf("Day23 Part1 Input  : %d\n", 11320);
	}
	ck_assert_int_eq(exampleResult , 12521);
}
END_TEST

START_TEST(Day23_P2)
{	
	int exampleResult = day23_p2("../src/Day23/day23.example");
	if(showResults){
		printf("Day23 Part2 Example: %d\n", exampleResult);
	
		//int inputResult = day23_p2("../src/Day23/day23.input");
		//printf("Day23 Part2 Input  : %d\n", inputResult);
		printf("Day23 Part2 Input  : %d\n", 49532);
		printf("\n");
	}
	ck_assert_int_eq(exampleResult , 44169);
}
END_TEST
